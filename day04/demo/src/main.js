...
// 全局注册vant组件
import {Toast, Field,Button,Form,CellGroup,Cell, NavBar, Icon, Uploader,Dialog,ActionSheet,Tab,Tabs,PullRefresh,List, SwipeCell,Grid,GridItem,Search } from 'vant';
Vue.use(Toast)
Vue.use(Field)
Vue.use(Button)
Vue.use(Form)
